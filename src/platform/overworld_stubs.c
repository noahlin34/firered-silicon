...
const u8 EventScript_Bookshelf[] = { 0x02 };
const u8 EventScript_Burglary[] = { 0x02 };
const u8 EventScript_Cabinet[] = { 0x02 };
...
const u8 EventScript_Dresser[] = { 0x02 };
